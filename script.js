var allrows = localStorage.getItem('rowsize')? localStorage.getItem('rowsize') : 10;
var allcolumns = localStorage.getItem('colsize')? localStorage.getItem('colsize') : 10;
var inProgress = false;

var cellsToAnimate = [];
var createWalls = false;
const algorithm = "Breadth-First Search (BFS)";
var justFinished = false;
var animationState = null;
var startCell = [0, 0];
var endCell = [allrows - 1, allcolumns - 1];
var movingStart = false;
var movingEnd = false;

var newrows = 100 / allrows;
var newcolumns = 100 / allcolumns;
function generateGrid(rows, cols) {
	console.log(rows, cols);
	var grid = "<table style=''>";
...
function recursiveDivMazeHelper(iStart, iEnd, jStart, jEnd, horzStart, horzEnd, vertStart, vertEnd, walls, passages, bias){
	...
	if (bias == "VERTICAL"){
		var lineOrientation = x < 8 ? "VERTICAL" : "HORIZONTAL";
	} else if (bias == "HORIZONTAL"){
		var lineOrientation = x < 1 ? "VERTICAL" : "HORIZONTAL";
	} else { 
		var lineOrientation = x < 5 ? "VERTICAL" : "HORIZONTAL";
	}
